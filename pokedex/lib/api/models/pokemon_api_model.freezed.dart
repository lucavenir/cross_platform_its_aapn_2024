...
class _$PokemonApiModelImpl
  ...
  const _$PokemonApiModelImpl({required this.name, required this.url});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PokemonApiModel(name: $name, url: $url)';
  }
...
abstract class _PokemonApiModel implements PokemonApiModel {
  const factory _PokemonApiModel(
      ...
      required final String url}) = _$PokemonApiModelImpl;
