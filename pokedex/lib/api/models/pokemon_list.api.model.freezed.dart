...
mixin _$PokemonListApiModel {
  ...
  List<PokemonListResultApiModel> get results =>
...
abstract class $PokemonListApiModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? next,
      String? prev,
      List<PokemonListResultApiModel> results});
}
    ...
    return _then(_value.copyWith(
      ...
      results: null == results
          ...
          : results // ignore: cast_nullable_to_non_nullable
              as List<PokemonListResultApiModel>,
    ) as $Val);
  }
}
...
class _$PokemonListApiModelImpl
  ...
  const _$PokemonListApiModelImpl(
      ...
      this.next,
      this.prev,
      required final List<PokemonListResultApiModel> results})
      : _results = results;
  ...
  @override
  final String? prev;
  final List<PokemonListResultApiModel> _results;
  @override
  List<PokemonListResultApiModel> get results {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'PokemonListApiModel(count: $count, next: $next, prev: $prev, results: $results)';
  }
